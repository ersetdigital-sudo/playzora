...
export const metadata: Metadata = {
  ...
  keywords: ["top up game", "top up mobile legends", "top up free fire", "top up pubg mobile", "top up cod mobile", "top up magic chess go go", "beli diamond", "beli uc", "beli cp", "qris", "top up game online", "top up game instan", "top up game 24 jam"],
